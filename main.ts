...
basic.forever(function () {
    ...
    if (isTransmitting) {
        if (isLeftMotor) {
            ...
            Kitronik_VIEWTEXT32.displaySingleLineString(Kitronik_VIEWTEXT32.DisplayLine.Bottom, "Transmitting Left")
        } else {
            radio.sendValue("Rmotor", thisValue)
            Kitronik_VIEWTEXT32.displaySingleLineString(Kitronik_VIEWTEXT32.DisplayLine.Bottom, "Transmitting Right")
        }
    } else {
